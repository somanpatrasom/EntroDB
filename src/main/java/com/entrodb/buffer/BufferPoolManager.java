...
public class BufferPoolManager {
    ...
    public int getPoolSize()   { return frames.length; }
    public int getUsedFrames() { int u=0; for(var f:frames) if(f!=null) u++; return u; }
    public int getDirtyCount() { int d=0; for(var f:frames) if(f!=null && f.isDirty()) d++; return d; }
}
